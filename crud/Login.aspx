    ...
    <form id="form1" runat="server" class="container mt-5">
        <div class="card">
            <div class="card-body">
                ...
                <asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="btnLogin_Click" CssClass="btn btn-primary btn-block mb-3" />

                <%--<asp:Button ID="btnLoginWithGoogle" runat="server" Text="Login with Google" OnClick="btnLoginWithGoogle_Click" CssClass="btn btn-success btn-block mb-3" />--%>

                <asp:HyperLink ID="lnkSignUp" runat="server" NavigateUrl="~/SignUp.aspx" CssClass="text-info">
